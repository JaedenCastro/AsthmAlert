...
public class MakeroidAirtable extends AndroidNonvisibleComponent {
    ...
    public void GetAllData() throws Exception {
        String str = FusiontablesControl.AUTHORIZATION_HEADER_PREFIX + this.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM;
        try {
            HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(("https://api.airtable.com/v0/" + this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt + "/" + this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW + "?&view=" + this.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA).replaceAll(" ", "%20")).openConnection();
    ...
    public void GetAllWithOffset(String str, JSONArray jSONArray) {
        String str2 = FusiontablesControl.AUTHORIZATION_HEADER_PREFIX + this.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM;
        try {
            HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(("https://api.airtable.com/v0/" + this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt + "/" + this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW + "?&view=" + this.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA + "&offset=" + str).replaceAll(" ", "%20")).openConnection();
    ...
    public void Cell(int i, String str) throws Exception {
        HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(("https://api.airtable.com/v0/" + this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt + "/" + this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW + "?fields[]=" + str + "&view=" + this.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA).replaceAll(" ", "%20")).openConnection();
        httpURLConnection.setRequestProperty(Constants.AUTHORIZATION_HEADER, FusiontablesControl.AUTHORIZATION_HEADER_PREFIX + this.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM);
        httpURLConnection.setRequestProperty(DefaultHttpClient.CONTENT_TYPE_KEY, "application/json");
    ...
    public void GetCellWithOffset(String str, JSONArray jSONArray, String str2, int i) {
        String str3 = FusiontablesControl.AUTHORIZATION_HEADER_PREFIX + this.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM;
        try {
            HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(("https://api.airtable.com/v0/" + this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt + "/" + this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW + "?fields[]=" + str2 + "&view=" + this.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA + "&offset=" + str).replaceAll(" ", "%20")).openConnection();
    ...
    public void Column(String str, int i) throws Exception {
        ...
        HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(("https://api.airtable.com/v0/" + this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt + "/" + this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW + "?fields[]=" + str + "&maxRecords=" + i + "&view=" + this.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA).replaceAll(" ", "%20")).openConnection();
        httpURLConnection.setRequestProperty(Constants.AUTHORIZATION_HEADER, FusiontablesControl.AUTHORIZATION_HEADER_PREFIX + this.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM);
        httpURLConnection.setRequestProperty(DefaultHttpClient.CONTENT_TYPE_KEY, "application/json");
        final int responseCode = httpURLConnection.getResponseCode();
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(httpURLConnection.getInputStream()));
    ...
    public void ColumnWithOffset(List<String> list, List<String> list2, List<String> list3, String str, int i, String str2) throws Exception {
        String str3 = str;
        HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(("https://api.airtable.com/v0/" + this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt + "/" + this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW + "?fields[]=" + str3 + "&maxRecords=" + i + "&view=" + this.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA + "&offset=" + str2).replaceAll(" ", "%20")).openConnection();
        httpURLConnection.setRequestProperty(Constants.AUTHORIZATION_HEADER, FusiontablesControl.AUTHORIZATION_HEADER_PREFIX + this.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM);
        httpURLConnection.setRequestProperty(DefaultHttpClient.CONTENT_TYPE_KEY, "application/json");
        final int responseCode = httpURLConnection.getResponseCode();
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(httpURLConnection.getInputStream()));
    ...
    public void setCell(int r9, java.lang.String r10, java.lang.String r11) throws java.lang.Exception {
        /*
            ...
            r2.<init>(r3)
            java.lang.String r3 = r8.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM
            r2.append(r3)
            java.lang.String r2 = r2.toString()
            org.json.JSONArray r3 = new org.json.JSONArray
            java.lang.String r4 = r8.NqI9fRlBp15rsxXeNmRjOrUuQwDxdaDY0xSQj1B7T50sMWnnasnmhTtbykVZmafW
            r3.<init>(r4)
            r4 = 1
            int r9 = r9 - r4
            ...
            java.lang.String r7 = r8.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW     // Catch:{ MalformedURLException -> 0x00fd, Exception -> 0x00ef }
            r6.append(r7)     // Catch:{ MalformedURLException -> 0x00fd, Exception -> 0x00ef }
            r6.append(r0)     // Catch:{ MalformedURLException -> 0x00fd, Exception -> 0x00ef }
    ...
    public void deleteRowNum(int i) throws Exception {
        GetAllData();
        HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(("https://api.airtable.com/v0/" + this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt + "/" + this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW + "/" + new JSONArray(this.NqI9fRlBp15rsxXeNmRjOrUuQwDxdaDY0xSQj1B7T50sMWnnasnmhTtbykVZmafW).getJSONObject(i - 1).getString(CommonProperties.ID)).replaceAll(" ", "%20")).openConnection();
        httpURLConnection.setRequestProperty(Constants.AUTHORIZATION_HEADER, FusiontablesControl.AUTHORIZATION_HEADER_PREFIX + this.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM);
        httpURLConnection.setRequestProperty(DefaultHttpClient.CONTENT_TYPE_KEY, "application/json");
    ...
    public void createRow(com.google.appinventor.components.runtime.util.YailList r7, com.google.appinventor.components.runtime.util.YailList r8) throws java.lang.Exception {
        /*
            ...
            r1.<init>(r2)
            java.lang.String r2 = r6.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM
            r1.append(r2)
        ...
        L_0x002d:
            ...
            java.lang.String r4 = "/"
            r3.append(r4)     // Catch:{ MalformedURLException -> 0x00f9, Exception -> 0x00eb }
            java.lang.String r4 = r6.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW     // Catch:{ MalformedURLException -> 0x00f9, Exception -> 0x00eb }
            r3.append(r4)     // Catch:{ MalformedURLException -> 0x00f9, Exception -> 0x00eb }
    ...
    public void updateRowByNum(int r8, com.google.appinventor.components.runtime.util.YailList r9, com.google.appinventor.components.runtime.util.YailList r10) throws java.lang.Exception {
        /*
            ...
            java.lang.String r2 = "Bearer "
            r1.<init>(r2)
            java.lang.String r2 = r7.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM
            r1.append(r2)
            java.lang.String r1 = r1.toString()
            java.lang.String[] r9 = r9.toStringArray()
            java.lang.String[] r10 = r10.toStringArray()
            org.json.JSONArray r2 = new org.json.JSONArray
            java.lang.String r3 = r7.NqI9fRlBp15rsxXeNmRjOrUuQwDxdaDY0xSQj1B7T50sMWnnasnmhTtbykVZmafW
            r2.<init>(r3)
            r3 = 1
            int r8 = r8 - r3
        ...
        L_0x0043:
            ...
            java.lang.String r5 = r7.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW     // Catch:{ Exception -> 0x0101 }
            r4.append(r5)     // Catch:{ Exception -> 0x0101 }
            r4.append(r0)     // Catch:{ Exception -> 0x0101 }
