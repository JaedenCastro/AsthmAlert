...
public class FusiontablesControl extends AndroidNonvisibleComponent implements Component {
    ...
    /* renamed from: JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd  reason: collision with other field name */
    private boolean f124JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd = true;
    ...
    public File f125hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = null;
    /* access modifiers changed from: private */
    ...
    private boolean f126qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM = false;
    ...
    public FusiontablesControl(ComponentContainer componentContainer) {
        ...
        this.JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd = "show tables";
    }
    ...
    public boolean UseServiceAuthentication() {
        return this.f126qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM;
    }

    @DesignerProperty(defaultValue = "False", editorType = "boolean")
    @SimpleProperty
    public void UseServiceAuthentication(boolean z) {
        this.f126qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM = z;
    }
    ...
    public void ServiceAccountEmail(String str) {
        this.ZYL9KAfl6ZZzM9RsykyXLexYTPR8S0eQ9Guil6cW84HmbyBTkvTBFTgEwGE4p6T = str;
    }
    ...
    public void Query(String str) {
        this.JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd = str;
    }
    ...
    public void KeyFile(String str) {
        if (!str.equals(this.UCfQaCFj2ASJbfyESztjl1SvQCaE7JCSj517yoZD3j82N9syinSTFfGgPUXIenmO)) {
            File file = this.f125hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
            if (file != null) {
                file.delete();
                this.f125hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = null;
            }
            if (str == null) {
                str = "";
            }
    ...
    public void SendQuery() {
        if (this.havePermission) {
            new b(this.activity).execute(new String[]{this.JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd});
            return;
        }
    ...
    public void DoQuery() {
        new a(this, (byte) 0).execute(new String[]{this.JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd});
    }
    ...
    public void InsertRow(String str, String str2, String str3) {
        this.JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd = "INSERT INTO " + str + " (" + str2 + ") VALUES (" + str3 + ")";
        if (this.havePermission) {
            new b(this.activity).execute(new String[]{this.JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd});
            return;
        }
    ...
    public void GetRows(String str, String str2) {
        this.JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd = "SELECT " + str2 + " FROM " + str;
        if (this.havePermission) {
            new b(this.activity).execute(new String[]{this.JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd});
            return;
        }
    ...
    public void GetRowsWithConditions(String str, String str2, String str3) {
        this.JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd = "SELECT " + str2 + " FROM " + str + " WHERE " + str3;
        if (this.havePermission) {
            new b(this.activity).execute(new String[]{this.JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd});
            return;
        }
    ...
    public void ShowLoadingDialog(boolean z) {
        this.f124JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd = z;
    }

    @SimpleProperty(category = PropertyCategory.BEHAVIOR, description = "Whether or not to show the loading dialog")
    public boolean ShowLoadingDialog() {
        return this.f124JG8vik3adkKEwGQS5cMPy19gFsDVhfFFU9AjX5Lm2B7MWziHu9erYgT687JlCqd;
    }
    ...
    public com.google.api.client.http.HttpResponse sendQuery(String str, String str2) {
        ...
        try {
            ...
            this.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1 = e.getMessage();
            return null;
        } catch (GoogleJsonResponseException e2) {
            this.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1 = e2.getMessage();
            Log.e("FUSION", "JsonResponseException");
            Log.e("FUSION", "e.getMessage() is " + e2.getMessage());
            Log.e("FUSION", "response is " + null);
            return null;
        } catch (IOException e3) {
            this.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1 = e3.getMessage();
        ...
        try {
            ...
            try {
                ...
                if (execute == null || statusCode != 200) {
                    ...
                    this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN = execute.getStatusLine().toString();
                } else {
                    try {
                        ...
                        if (jSONObject.has("tableId")) {
                            this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN = "tableId," + jSONObject.get("tableId");
                        } else {
                            this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN = httpApacheResponseToString;
                        }
                        Log.i("FUSION", "Response code = " + execute.getStatusLine());
                        Log.i("FUSION", "Query = " + str + "\nResultStr = " + this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN);
    ...
    class b extends AsyncTask<String, Void, String> {
        ...
        public final /* synthetic */ Object doInBackground(Object[] objArr) {
            ...
            String unused = FusiontablesControl.this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN = "";
            ...
            if (str.toLowerCase().contains("create table")) {
                ...
                String unused2 = fusiontablesControl.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN = fusiontablesControl.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(FusiontablesControl.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T(str), refreshedAuthToken);
                return FusiontablesControl.this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN;
            }
            com.google.api.client.http.HttpResponse sendQuery = FusiontablesControl.this.sendQuery(str, refreshedAuthToken);
            if (sendQuery != null) {
                String unused3 = FusiontablesControl.this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN = FusiontablesControl.httpResponseToString(sendQuery);
                Log.i("QueryProcessorV2", "Query = " + str + "\nResultStr = " + FusiontablesControl.this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN);
            } else {
                FusiontablesControl fusiontablesControl2 = FusiontablesControl.this;
                String unused4 = fusiontablesControl2.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN = fusiontablesControl2.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1;
                Log.i("QueryProcessorV2", "Error:  " + FusiontablesControl.this.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1);
            }
            return FusiontablesControl.this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN;
        }
        ...
        public final /* synthetic */ void onPostExecute(Object obj) {
            ...
            if (str == null) {
                str = FusiontablesControl.this.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1;
            }
        ...
        private String wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou(String str) {
            String unused = FusiontablesControl.this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN = "";
            FusiontablesControl fusiontablesControl = FusiontablesControl.this;
            String unused2 = fusiontablesControl.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1 = fusiontablesControl.OAUx2n1xMKzXfjTj5DCb1XzhEYBfmj7wvFgBr5BSQUCav1CowwMbt2iKFNQwGzpG;
            HttpTransport newCompatibleTransport = AndroidHttp.newCompatibleTransport();
            GsonFactory gsonFactory = new GsonFactory();
            Log.i("FUSION_SERVICE_ACCOUNT", "keyPath " + FusiontablesControl.this.UCfQaCFj2ASJbfyESztjl1SvQCaE7JCSj517yoZD3j82N9syinSTFfGgPUXIenmO);
            try {
                if (FusiontablesControl.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(FusiontablesControl.this) == null) {
                    FusiontablesControl fusiontablesControl2 = FusiontablesControl.this;
                    File unused3 = fusiontablesControl2.f125hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = MediaUtil.copyMediaToTempFile(FusiontablesControl.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(fusiontablesControl2).$form(), FusiontablesControl.this.UCfQaCFj2ASJbfyESztjl1SvQCaE7JCSj517yoZD3j82N9syinSTFfGgPUXIenmO);
                }
                Fusiontables.Query.Sql sql = new Fusiontables.Builder(newCompatibleTransport, gsonFactory, new GoogleCredential.Builder().setTransport(newCompatibleTransport).setJsonFactory(gsonFactory).setServiceAccountId(FusiontablesControl.this.ZYL9KAfl6ZZzM9RsykyXLexYTPR8S0eQ9Guil6cW84HmbyBTkvTBFTgEwGE4p6T).setServiceAccountScopes(new String[]{FusiontablesControl.this.muMCPHZoR5LDcgNaOoyYPcH1tjqU9LHoHV7Yzgex9Dj2uE6xbcPRtlEMsWbJpsbN}).setServiceAccountPrivateKeyFromP12File(FusiontablesControl.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(FusiontablesControl.this)).build()).setJsonHttpRequestInitializer(new GoogleKeyInitializer(FusiontablesControl.this.ApiKey())).build().query().sql(str);
                sql.put("alt", "csv");
                ...
                try {
                    ...
                    String unused4 = fusiontablesControl3.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1 = str2;
                    FusiontablesControl.this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(str, FusiontablesControl.this.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1);
                } catch (Exception e2) {
                    ...
                    String unused5 = FusiontablesControl.this.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1 = e2.getMessage();
                    FusiontablesControl.this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(str, FusiontablesControl.this.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1);
                }
                if (httpResponse != null) {
                    String unused6 = FusiontablesControl.this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN = FusiontablesControl.httpResponseToString(httpResponse);
                    Log.i("FUSION_SERVICE_ACCOUNT", "Query = " + str + "\nResultStr = " + FusiontablesControl.this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN);
                } else {
                    FusiontablesControl fusiontablesControl4 = FusiontablesControl.this;
                    String unused7 = fusiontablesControl4.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN = fusiontablesControl4.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1;
                    Log.i("FUSION_SERVICE_ACCOUNT", "Error with null response:  " + FusiontablesControl.this.YPNDRC6guNtR9Y1y2H2jw2eNOGhWZENW1YRifRdfZVF6tZ3Hhm9vVsLmqobDf9o1);
                }
                ...
                Log.e("FUSION", String.valueOf(e3));
                String unused8 = FusiontablesControl.this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN = e3.getMessage();
            } catch (Throwable th) {
                Log.i("FUSION_SERVICE_ACCOUNT", "in Catch Throwable e");
                String unused9 = FusiontablesControl.this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN = th.getMessage();
            }
            Log.i("FUSION_SERVICE_ACCOUNT", "returning queryResultStr = " + FusiontablesControl.this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN);
            return FusiontablesControl.this.joZZFkzhsHdrkrd2PnThIkJfOfuAzcTTVQ9uzSCPDoVjmnvQXSliAgIhSj7yEkSN;
        }
    }
