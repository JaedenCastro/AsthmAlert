...
public class TextToSpeech extends AndroidNonvisibleComponent implements Component, OnDestroyListener, OnResumeListener, OnStopListener {
    ...
    public boolean q8iygSjgpTZ52A5K8GXhnvUs2CX4iXd4uIVtwvououVquIzlzfVOfWIR3CjSHG4 = false;
    ...
    public TextToSpeech(ComponentContainer componentContainer) {
        ...
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = new InternalTextToSpeech(componentContainer.$context(), new ITextToSpeech.TextToSpeechCallback() {
            public final void onSuccess() {
                boolean unused = TextToSpeech.this.q8iygSjgpTZ52A5K8GXhnvUs2CX4iXd4uIVtwvououVquIzlzfVOfWIR3CjSHG4 = true;
                TextToSpeech.this.AfterSpeaking(true);
            }

            public final void onFailure() {
                boolean unused = TextToSpeech.this.q8iygSjgpTZ52A5K8GXhnvUs2CX4iXd4uIVtwvououVquIzlzfVOfWIR3CjSHG4 = false;
    ...
    public void Language(String str) {
        ...
        if (length == 2) {
            ...
            this.tFNQ38WX0EWx1sBmwkfGOavwj0ohdRyv5RfL5KQ0qa5Pnr6qc7YsZTQu1aP3NtmA = locale.getLanguage();
        } else {
            ...
            this.tFNQ38WX0EWx1sBmwkfGOavwj0ohdRyv5RfL5KQ0qa5Pnr6qc7YsZTQu1aP3NtmA = locale.getISO3Language();
        }
        this.KYHvnTv0AWOO8SeFCXsiNXCxcIirISbo8kAOvMnivJLnqAuCVxfixET1OT3ZpHhw = locale.getLanguage();
    }
    ...
    public void Country(String str) {
        ...
        if (length == 2) {
            Locale locale2 = new Locale(str);
            this.siVQGK7skYIQ7zI3RxZVmSEN1N3qEwDlBDPORHd716EIgwqH2EWQFUJrvV0SXYUL = locale2.getCountry();
            locale = locale2;
        } else if (length != 3) {
            locale = Locale.getDefault();
            this.siVQGK7skYIQ7zI3RxZVmSEN1N3qEwDlBDPORHd716EIgwqH2EWQFUJrvV0SXYUL = locale.getCountry();
        } else {
            ...
            this.siVQGK7skYIQ7zI3RxZVmSEN1N3qEwDlBDPORHd716EIgwqH2EWQFUJrvV0SXYUL = locale.getISO3Country();
        }
        this.LYXVmrSApJtjkX58iaWYcT93zXSX0GhbrHTAKbm3TBRJ5avsjGCN1sJz61Za2zkA = locale.getCountry();
    }
    ...
    public void Speak(String str) {
        BeforeSpeaking();
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.speak(str, new Locale(this.KYHvnTv0AWOO8SeFCXsiNXCxcIirISbo8kAOvMnivJLnqAuCVxfixET1OT3ZpHhw, this.LYXVmrSApJtjkX58iaWYcT93zXSX0GhbrHTAKbm3TBRJ5avsjGCN1sJz61Za2zkA));
    }
