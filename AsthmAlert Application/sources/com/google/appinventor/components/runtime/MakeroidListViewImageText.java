...
public class MakeroidListViewImageText extends MakeroidListViewBase {
    ...
    private ArrayList<ArrayList<String>> f207hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = new ArrayList<>();
    ...
    /* access modifiers changed from: private */
    public boolean q2q4oDuUajVwr2T7b6DILrrBhrCqmElgSd3ODKsAFi8uEX2COWatdRT7gov0FlS5 = false;
    private boolean seAn8f9TucJq5ZQrZ6xvA6wzyVfqYrHR0kVGH9g6Rg5gdXevmQRBQv2iJqrzi5Rz = false;
    private int size = 1;
    ...
    public MakeroidListViewImageText(ComponentContainer componentContainer) {
        ...
        TitleBold(this.seAn8f9TucJq5ZQrZ6xvA6wzyVfqYrHR0kVGH9g6Rg5gdXevmQRBQv2iJqrzi5Rz);
        ...
        TitleHTML(this.q2q4oDuUajVwr2T7b6DILrrBhrCqmElgSd3ODKsAFi8uEX2COWatdRT7gov0FlS5);
        TitleItalic(this.LVnP8NaPYXRgwZHgDK7PHMVEgcKwsNvZv2AHicCDg6yGIfguFikZkwwgr0dhWzJE);
        SubtitleTextSize(this.gti6bIqu0aXgALoDtkq1foMnPcdzXO0EAPAgw4lcaEF132GirFLns82VqwKc8x6R);
        SubtitleBold(this.cOmDbOC978RubVhXjun4VkHg9OxeO5ZzRCTQEv8rZa8E7YdcVv7aSE4TjAXwfuwN);
        ...
        SubtitleHTML(this.O8YFlD3Safgd5vkxHRoLznZm2if21MG0IxIn5jepRi6FBTeulibRFlvEXsnDANgS);
        SubtitleItalic(this.OFXnSk7pjyu5TDlQcCs0Ee2Ss8ceD26gQ4XJfzIMtdlcKhGXQ2j7Mh9NsuvjNyC);
    }

    public void click(int i) {
        try {
            Click(i, (String) this.f207hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(i).get(1), (String) this.f207hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(i).get(2), (String) this.f207hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(i).get(0));
    ...
    public void longClick(int i) {
        try {
            LongClick(i, (String) this.f207hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(i).get(1), (String) this.f207hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(i).get(2), (String) this.f207hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(i).get(0));
        } catch (ArrayIndexOutOfBoundsException unused) {
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.notifyDataSetChanged();
        }
    }
    ...
    public void AddItem(String str, String str2, String str3) {
        ...
        arrayList.add(str2);
        arrayList.add(str3);
        this.f207hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.add(arrayList);
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.notifyDataSetChanged();
    }
    ...
    public void ClearList() {
        this.f207hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.clear();
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.notifyDataSetChanged();
    }
    ...
    public void UpdateItem(int i, String str, String str2, String str3) throws ArrayIndexOutOfBoundsException {
        ...
        arrayList.add(str2);
        arrayList.add(str3);
        this.f207hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.set(i, arrayList);
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.notifyDataSetChanged();
    }

    @SimpleFunction(description = "Remove a item from the list")
    public void RemoveItem(int i) throws ArrayIndexOutOfBoundsException {
        this.f207hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.remove(i);
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.notifyDataSetChanged();
    }
    ...
    public void SubtitleFontTypefaceImport(String str) {
        this.G7Lxwqvaa0zcPMEYmgjECqcap18lY2TYRMrZOi1cD4z0oU809LnjVuckWEr78wl = str;
    }
    ...
    public class ListAdapter extends RecyclerView.Adapter<a> {
        ...
        public void onBindViewHolder(a aVar, int i) {
            ...
            if (((String) arrayList.get(1)).length() > 0) {
                ...
                if (MakeroidListViewImageText.this.q2q4oDuUajVwr2T7b6DILrrBhrCqmElgSd3ODKsAFi8uEX2COWatdRT7gov0FlS5) {
            ...
            if (((String) arrayList.get(2)).length() > 0) {
                ...
                if (MakeroidListViewImageText.this.O8YFlD3Safgd5vkxHRoLznZm2if21MG0IxIn5jepRi6FBTeulibRFlvEXsnDANgS) {
