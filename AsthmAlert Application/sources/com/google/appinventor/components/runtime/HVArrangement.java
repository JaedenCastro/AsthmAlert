...
public class HVArrangement extends AndroidViewComponent implements Component, ComponentContainer {
    ...
    private boolean Qws8UL0KACxj4AFwEq11K2awfkG72XuPUTZHhPLrlGlIXoxeK9stYQCrIWmabWcL = false;
    ...
    public void isCard(boolean z) {
        ...
        if (z) {
            ...
            KodularHelper.setShape(this.f160hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, i2, i, this.Qws8UL0KACxj4AFwEq11K2awfkG72XuPUTZHhPLrlGlIXoxeK9stYQCrIWmabWcL);
    ...
    private void updateAppearance() {
        if (this.backgroundImageDrawable == null) {
            ...
            if (this.eaS298peKlTpqlGRGLMTdk3sY259qoFGMqAzTE98DZy2JVNgCwB414XzHrUPTC) {
                int i = this.backgroundColor;
                KodularHelper.setShape(this.f160hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, i, i == 16777215 ? -1 : i, this.Qws8UL0KACxj4AFwEq11K2awfkG72XuPUTZHhPLrlGlIXoxeK9stYQCrIWmabWcL);
                return;
            }
            return;
        }
