...
public class MakeroidInstantAccess extends AndroidNonvisibleComponent implements Component {
    ...
    public void Request(String str) {
        String str2 = "https://dashboard.instantaccess.io/api/partner/authorize?client_id=" + this.I88voynnB6lCbi2eFsNA2DcXYsTa46aEiMaovSB2sEx9V3gZP1qdgaJzEiYc8qjH + "&client_secret=" + this.boZncMwfbKhn9wEZVXOlCQaCALViR3x19GsnEC1EZxndIE2ufazY5HxCE0U58Zvt + "&user_identifier=" + str;
        String str3 = this.I88voynnB6lCbi2eFsNA2DcXYsTa46aEiMaovSB2sEx9V3gZP1qdgaJzEiYc8qjH;
        ...
        String str4 = this.boZncMwfbKhn9wEZVXOlCQaCALViR3x19GsnEC1EZxndIE2ufazY5HxCE0U58Zvt;
    ...
    public void CheckStatus(String str) {
        String str2 = "https://dashboard.instantaccess.io/api/partner/status?client_id=" + this.I88voynnB6lCbi2eFsNA2DcXYsTa46aEiMaovSB2sEx9V3gZP1qdgaJzEiYc8qjH + "&client_secret=" + this.boZncMwfbKhn9wEZVXOlCQaCALViR3x19GsnEC1EZxndIE2ufazY5HxCE0U58Zvt + "&user_identifier=" + str;
        String str3 = this.I88voynnB6lCbi2eFsNA2DcXYsTa46aEiMaovSB2sEx9V3gZP1qdgaJzEiYc8qjH;
        if (str3 == null || str3.isEmpty()) {
    ...
    public void ClientSecret(String str) {
        this.boZncMwfbKhn9wEZVXOlCQaCALViR3x19GsnEC1EZxndIE2ufazY5HxCE0U58Zvt = str;
    }
