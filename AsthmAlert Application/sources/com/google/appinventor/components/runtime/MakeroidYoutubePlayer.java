...
public class MakeroidYoutubePlayer extends AndroidViewComponent {
    ...
    private YouTubePlayerView f223hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    /* access modifiers changed from: private */

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    public PlayerUIController f224hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private YouTubePlayerTracker f225hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public MakeroidYoutubePlayer(ComponentContainer componentContainer) {
        ...
        this.f223hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = new YouTubePlayerView(this.context);
        this.f225hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = new YouTubePlayerTracker();
        this.f223hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.initialize(new YouTubePlayerInitListener() {
            public final void onInitSuccess(YouTubePlayer youTubePlayer) {
                ...
                PlayerUIController unused2 = makeroidYoutubePlayer.f224hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = MakeroidYoutubePlayer.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(makeroidYoutubePlayer).getPlayerUIController();
    ...
    public YouTubePlayerView getView() {
        return this.f223hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    }
    ...
    public void StartSecond(float f) {
        ...
        this.q8iygSjgpTZ52A5K8GXhnvUs2CX4iXd4uIVtwvououVquIzlzfVOfWIR3CjSHG4 = String.valueOf(f);
    }
    ...
    public void Volume(int i) {
        if (i > 100 || i < 0) {
            ...
            this.q8iygSjgpTZ52A5K8GXhnvUs2CX4iXd4uIVtwvououVquIzlzfVOfWIR3CjSHG4 = sb.toString();
    ...
    public boolean IsFullscreen() {
        return this.f223hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isFullScreen();
    }

    @SimpleFunction(description = "Toggle the state of the video player.")
    public void ToggleFullscreen() {
        this.f223hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.toggleFullScreen();
    }

    @SimpleFunction(description = "Enter the video in fullscreen mode.")
    public void EnterFullscreen() {
        this.f223hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.enterFullScreen();
    }

    @SimpleFunction(description = "Exit the video from fullscreen mode.")
    public void ExitFullscreen() {
        this.f223hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.exitFullScreen();
    }
    ...
    public float GetCurrentSecond() {
        if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            return this.f225hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getCurrentSecond();
        }
        return 0.0f;
    }
    ...
    public float GetVideoDuration() {
        if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            return this.f225hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getVideoDuration();
        }
        return 0.0f;
    }
    ...
    public void EnableLiveVideoUI(boolean z) {
        this.z89WSVwZ7PB2CmtTjCz6wAa186XxEwXZ6USChsRUkmrmINCnliZwpzt9cagYiYvX = z;
        PlayerUIController playerUIController = this.f224hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
