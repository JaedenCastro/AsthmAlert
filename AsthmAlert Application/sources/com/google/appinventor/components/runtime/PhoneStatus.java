...
public class PhoneStatus extends AndroidNonvisibleComponent implements Component {
    ...
    private static boolean bjRTr59rlfMAk3NoImwosXnapn2cygGkKCeZagS1kgI5blNKx2IlW2vUboyQWmzb = true;
    private static PhoneStatus hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public String setHmacSeedReturnCode(String str, String str2) {
        ...
        String str3 = this.yHAbLPerXNK4pCwn5nqbt3OeUjDvQdxh29RmVa0moB4dUtgatbeaGoP5jClPUWFb;
        if (str3 != null) {
            if (!str3.equals(str)) {
        ...
        if (!bjRTr59rlfMAk3NoImwosXnapn2cygGkKCeZagS1kgI5blNKx2IlW2vUboyQWmzb) {
        ...
        try {
            ...
            this.Sj3UMCQcT7f46E8U4TVavenawPElr174psURarVHJJBTqMXe22hIekct3fzxe7Vm = stringBuffer2;
    ...
    public void startWebRTC(String str, String str2) {
        if (bjRTr59rlfMAk3NoImwosXnapn2cygGkKCeZagS1kgI5blNKx2IlW2vUboyQWmzb) {
            ...
            webRTCNativeMgr.initiate((ReplForm) this.form, activity, this.yHAbLPerXNK4pCwn5nqbt3OeUjDvQdxh29RmVa0moB4dUtgatbeaGoP5jClPUWFb);
    ...
    public void WebRTC(boolean z) {
        bjRTr59rlfMAk3NoImwosXnapn2cygGkKCeZagS1kgI5blNKx2IlW2vUboyQWmzb = z;
    }
    ...
    public boolean WebRTC() {
        return bjRTr59rlfMAk3NoImwosXnapn2cygGkKCeZagS1kgI5blNKx2IlW2vUboyQWmzb;
    }
