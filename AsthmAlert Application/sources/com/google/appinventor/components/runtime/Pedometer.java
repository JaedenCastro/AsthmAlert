...
public class Pedometer extends AndroidNonvisibleComponent implements SensorEventListener, Component, Deleteable {
    ...
    private float[] f241Co1rSUoyBoOJ9n0NOgrpxvTYmRPklnETeodUBiQlSBK151C8PCv1Q1Pl4SUa1qxB = new float[10];
    private boolean D5WW7ko68TBhY3rWGJixZsWe3BbuoJE4ehTpLkVzvzCwqdv8qeJ2dPQYU5v0Rxk = true;
    private boolean FlE8cJN9pJT0vK7EOYVYVCxuB0sJcG6jpZ55tqfSsTRV8K3RkDe9yvLjVOLhsxDi = false;
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (sensorEvent2.sensor.getType() == 1) {
            ...
            if (this.FlE8cJN9pJT0vK7EOYVYVCxuB0sJcG6jpZ55tqfSsTRV8K3RkDe9yvLjVOLhsxDi) {
                ...
                if (z2 && this.MPU09J1AwAGHHipshACCcxJb3sgE9iJCZW8vEkhwkK7OZvOaOd0ZOicUGCeoxucl && this.qPeHJnCLP0dAOwDPeFIn82vcSIsCMh6KFFn3o4kyIe0RhQKOQXDeyY2LFwPu2GbE[i2] - this.vB3WjEtL56PUGm0spJ96S19MI1O4vPR6yju8tUYcKrC4atk0AV5GbVcHQNB7BlIK > 40.0f) {
            ...
            float[] fArr3 = this.f241Co1rSUoyBoOJ9n0NOgrpxvTYmRPklnETeodUBiQlSBK151C8PCv1Q1Pl4SUa1qxB;
            ...
            float length2 = fArr5[i14] / ((float) this.f241Co1rSUoyBoOJ9n0NOgrpxvTYmRPklnETeodUBiQlSBK151C8PCv1Q1Pl4SUa1qxB.length);
            fArr5[i14] = length2;
            boolean z4 = this.FlE8cJN9pJT0vK7EOYVYVCxuB0sJcG6jpZ55tqfSsTRV8K3RkDe9yvLjVOLhsxDi;
            if (z4 || i14 > 1) {
                int i15 = i14 - 1;
                if (i15 < 0) {
                    i15 += 100;
            ...
            if (i17 == 99 && !this.FlE8cJN9pJT0vK7EOYVYVCxuB0sJcG6jpZ55tqfSsTRV8K3RkDe9yvLjVOLhsxDi) {
