...
public class MakeroidBottomSheet extends AndroidNonvisibleComponent implements Component {
    ...
    private boolean o4oEL8NAO5pXZcOSBAknA2NvsNjJJvehWW0lJ74yBWMu5XdCwoMznIBTr1ZGCAX = false;
    private boolean showStatusBar = true;
    private boolean xaven5ecM0Ll2H1GHPRV82tONpToW8URGRDgxbH0b2M0q5wAsNNBDrpsKvL0qvHt = true;
    ...
    public void Update() {
        ...
        if (bottomSheetDialog != null && bottomSheetDialog.getWindow() != null) {
            ...
            Log.i("Bottom Sheet Component", "Dim Background is set to " + this.xaven5ecM0Ll2H1GHPRV82tONpToW8URGRDgxbH0b2M0q5wAsNNBDrpsKvL0qvHt);
