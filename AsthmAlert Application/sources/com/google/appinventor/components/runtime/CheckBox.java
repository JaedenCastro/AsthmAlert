...
public final class CheckBox extends AndroidViewComponent implements View.OnClickListener, View.OnFocusChangeListener, CompoundButton.OnCheckedChangeListener {
    ...
    public CheckBox(ComponentContainer componentContainer) {
        ...
        TextViewUtil.setFontTypeface(appCompatCheckBox, this.fontTypeface, this.yKzj3OK1ig8r7pqFZ5OXQyoqJiWnRvwjZPZ1kORJGZPQRb8FuKJuM2qAKu5QCSLT, this.PpoaLB2hgzDTOuqu9FkRmbGOAi4DOSz44cSb2WOQzHfJN0AfA0f9dWyZXVLXkHHC);
        FontSize(14.0f);
        Text("");
        TextColor(-16777216);
        Checked(false);
