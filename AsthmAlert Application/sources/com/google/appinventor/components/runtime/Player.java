...
public final class Player extends AndroidNonvisibleComponent implements MediaPlayer.OnCompletionListener, Component, Deleteable, OnDestroyListener, OnPauseListener, OnResumeListener, OnStopListener {
    ...
    private void PpoaLB2hgzDTOuqu9FkRmbGOAi4DOSz44cSb2WOQzHfJN0AfA0f9dWyZXVLXkHHC() {
        ...
        this.t2ckruxpPDflxUi8XRIoUkd3SPCNiaP1fIl9I8fgeRcif548vLOXCzLwJMVgcQrg = focusRequestGranted;
    ...
    public final void Loop(boolean z) {
        ...
        this.f9MsIiC6MxciaFVJmtpdDaPCPu1tdZDTYoHbgfSwKXBhLXF2LgZTKbRmVlZ1kb0Z = z;
    }
    ...
    public final boolean PlayOnlyInForeground() {
        return this.haiIuOdmUoc5XQFvR9GJKGOwB3ZezhsWV0MdG7MgpkerzHclvrTRoGLrsRSHUTL5;
    }

    @DesignerProperty(defaultValue = "False", editorType = "boolean")
    @SimpleProperty
    public final void PlayOnlyInForeground(boolean z) {
        this.haiIuOdmUoc5XQFvR9GJKGOwB3ZezhsWV0MdG7MgpkerzHclvrTRoGLrsRSHUTL5 = z;
    }
    ...
    public final void onResume() {
        if (this.haiIuOdmUoc5XQFvR9GJKGOwB3ZezhsWV0MdG7MgpkerzHclvrTRoGLrsRSHUTL5 && this.playerState == State.PAUSED_BY_EVENT) {
            Start();
        }
    }
    ...
    public final void onPause() {
        MediaPlayer mediaPlayer = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
        if (mediaPlayer != null && this.haiIuOdmUoc5XQFvR9GJKGOwB3ZezhsWV0MdG7MgpkerzHclvrTRoGLrsRSHUTL5 && mediaPlayer.isPlaying()) {
            pause();
        }
    }
