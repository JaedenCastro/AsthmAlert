...
public class Slider extends AndroidViewComponent implements SeekBar.OnSeekBarChangeListener {
    ...
    public boolean gmm7XQFeiJoCy8yWhIBdyNlesqTvuP4UyGLNuJ8TYBJTJ249gDjP9OHTkIprzI7;
    private ClipDrawable hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private final SeekBar f251hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public Slider(ComponentContainer componentContainer) {
        ...
        this.f251hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = seekBar;
        ...
        this.gmm7XQFeiJoCy8yWhIBdyNlesqTvuP4UyGLNuJ8TYBJTJ249gDjP9OHTkIprzI7 = true;
    ...
    private void sLSXXiYjDERyx7CKvO5GstTCcI8HiXXLiPYrugcXt2517h4ADL52v0RLLmUd9xMb() {
        ...
        this.f251hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setProgress((int) (((f - f2) / (this.kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA - f2)) * 100.0f));
    }
    ...
    public void RotationAngle(double d) {
        ...
        this.f251hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setRotation((float) d);
    }
    ...
    public void ThumbEnabled(boolean z) {
        ...
        this.f251hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setOnTouchListener(new View.OnTouchListener() {
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return !Slider.this.gmm7XQFeiJoCy8yWhIBdyNlesqTvuP4UyGLNuJ8TYBJTJ249gDjP9OHTkIprzI7;
            }
        });
    }
    ...
    public void ThumbImage(String str) {
        try {
            ...
            if (bitmapDrawable != null) {
                this.f251hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setThumb(bitmapDrawable);
            }
        } catch (Exception e) {
    ...
    public void ThumbColor(int i) {
        ...
        this.f251hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getThumb().mutate().setColorFilter(i, PorterDuff.Mode.SRC_IN);
    }
    ...
    public void PositionChanged(float f) {
        EventDispatcher.dispatchEvent(this.f251hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, this, "PositionChanged", Float.valueOf(f));
    }
    ...
    public void TouchDown() {
        EventDispatcher.dispatchEvent(this.f251hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, this, "TouchDown", new Object[0]);
    }
    ...
    public void TouchUp() {
        EventDispatcher.dispatchEvent(this.f251hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, this, "TouchUp", new Object[0]);
    }
