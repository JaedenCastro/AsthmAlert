...
public class GoogleSpreadsheet extends AndroidNonvisibleComponent implements Component {
    ...
    private String bM4TidozxzoY9OaFqMiIYPyvnCah6tSdq3o2XMkQik5CKYcFIbxeqf36lqbvGbmH = "Your Sheet Name";
    ...
    public void SheetName(String str) {
        this.bM4TidozxzoY9OaFqMiIYPyvnCah6tSdq3o2XMkQik5CKYcFIbxeqf36lqbvGbmH = str;
    }
    ...
    static /* synthetic */ void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(GoogleSpreadsheet googleSpreadsheet) {
        String str;
        String trim = googleSpreadsheet.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt.trim();
        googleSpreadsheet.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt = trim;
        if (trim.toLowerCase().endsWith("?dev=true")) {
            str = googleSpreadsheet.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt;
        } else {
            str = googleSpreadsheet.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt + "?dev=true";
            googleSpreadsheet.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt = str;
        }
        ...
        try {
            ...
            if (httpURLConnection.getResponseCode() == 200) {
                JSONArray jSONArray = (JSONArray) new JSONObject(sb.toString()).get(googleSpreadsheet.bM4TidozxzoY9OaFqMiIYPyvnCah6tSdq3o2XMkQik5CKYcFIbxeqf36lqbvGbmH);
    ...
    static /* synthetic */ void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(GoogleSpreadsheet googleSpreadsheet, String str) {
        ...
        googleSpreadsheet.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt = trim;
        if (trim.toLowerCase().endsWith("?dev=true")) {
            str2 = googleSpreadsheet.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt;
        } else {
            str2 = googleSpreadsheet.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt + "?dev=true";
            googleSpreadsheet.TQYS6YBjqkoWFaGULpL2H003Eu6rkiOxhECYAYl6g8NMleEVKHe9nH3AkWIoC5xt = str2;
        }
        try {
            HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(str2 + "/" + googleSpreadsheet.bM4TidozxzoY9OaFqMiIYPyvnCah6tSdq3o2XMkQik5CKYcFIbxeqf36lqbvGbmH).openConnection();
