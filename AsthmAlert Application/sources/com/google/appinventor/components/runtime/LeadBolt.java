...
public class LeadBolt extends AndroidNonvisibleComponent implements Component {
    ...
    private AppModuleListener hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = new AppModuleListener() {
        public final void onModuleLoaded(String str) {
            KodularAnalyticsUtil.adEvent(KodularAnalyticsUtil.Ads.NETWORK_LEADBOLT, LeadBolt.this.uylNXPbffZHriucQ1SAwUkLE9dP8WxwaWe5GnEXLipwyDpy1sV8NkWFXe3foYSTl ? KodularAnalyticsUtil.Ads.FORMAT_VIDEO : KodularAnalyticsUtil.Ads.FORMAT_INTERSTITIAL, LeadBolt.this.form);
    ...
    public boolean uylNXPbffZHriucQ1SAwUkLE9dP8WxwaWe5GnEXLipwyDpy1sV8NkWFXe3foYSTl = false;
