...
public class KodularRecaptcha extends AndroidNonvisibleComponent {
    ...
    public void SiteKey(String str) {
        this.tOvM9eIUWszKzvISo4zKh7g8MyRaLHuNLQ5NdigAhriBDKCBmghUBEUlM2ZIvV1J = str;
    }
    ...
    public void Prompt() {
        SafetyNet.getClient(this.form).verifyWithRecaptcha(this.tOvM9eIUWszKzvISo4zKh7g8MyRaLHuNLQ5NdigAhriBDKCBmghUBEUlM2ZIvV1J).addOnSuccessListener(new OnSuccessListener<SafetyNetApi.RecaptchaTokenResponse>() {
