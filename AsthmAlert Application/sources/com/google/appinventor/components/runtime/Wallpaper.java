...
public class Wallpaper extends AndroidNonvisibleComponent implements Component {
    ...
    private String sWkWFQQIaGTTPJU7vuPeCDLKqn4jxxxmuDj72oHwiIsFNDjkPpdypuJP0f6vFa3B = "wallpaperPicture.png";
    ...
    class b extends AsyncTask<String, String, String> {
        private boolean HD0pINq0k1DLtf3yXVbK8xQhU4iGPT4iryXVeTceizjENHUUCtIIAr11wB5gmj8l;
    ...
    public void SaveWallpaperAs(String str) {
        if (str == null || str.isEmpty()) {
            this.sWkWFQQIaGTTPJU7vuPeCDLKqn4jxxxmuDj72oHwiIsFNDjkPpdypuJP0f6vFa3B = "wallpaperPicture.png";
        } else {
            this.sWkWFQQIaGTTPJU7vuPeCDLKqn4jxxxmuDj72oHwiIsFNDjkPpdypuJP0f6vFa3B = str;
        }
        Log.i("Wallpaper", "Wallpaper save name is: " + this.sWkWFQQIaGTTPJU7vuPeCDLKqn4jxxxmuDj72oHwiIsFNDjkPpdypuJP0f6vFa3B);
    }
    ...
    public java.lang.String SaveUtil(android.graphics.drawable.Drawable r6) {
        /*
            ...
            java.lang.String r4 = "/"
            r3.append(r4)     // Catch:{ PermissionException -> 0x008b, FileNotFoundException -> 0x007a, Exception -> 0x0069 }
            java.lang.String r4 = r5.sWkWFQQIaGTTPJU7vuPeCDLKqn4jxxxmuDj72oHwiIsFNDjkPpdypuJP0f6vFa3B     // Catch:{ PermissionException -> 0x008b, FileNotFoundException -> 0x007a, Exception -> 0x0069 }
            r3.append(r4)     // Catch:{ PermissionException -> 0x008b, FileNotFoundException -> 0x007a, Exception -> 0x0069 }
