    ...
    public void RemoveFirst(String str) {
        ...
        firebaseTransaction(new Transactional(aVar) {
            ...
            public final Transaction.Result run(MutableData mutableData) {
                ...
                if (value == null) {
                    aVar.M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu = "Previous value was empty.";
                ...
                try {
                    if (value instanceof String) {
                        ...
                        if (objectFromJson instanceof List) {
                            ...
                            if (list.isEmpty()) {
                                aVar.M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu = "The list was empty";
                                return Transaction.abort();
                            }
                            ...
                            try {
                                ...
                                aVar.M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu = "Could not convert value to JSON.";
                                return Transaction.abort();
                            }
                        } else {
                            aVar.M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu = "You can only remove elements from a list.";
                            return Transaction.abort();
                        }
                    } else {
                        aVar.M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu = "Invalid JSON object in database (shouldn't happen!)";
                        return Transaction.abort();
                    }
                ...
                try {
                    if (value instanceof String) {
                        ...
                        if (objectFromJson instanceof List) {
                            ...
                            aVar.M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu = "You can only append to a list.";
                            return Transaction.abort();
                        }
                    } else {
                        aVar.M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu = "Invalid JSON object in database (shouldn't happen!)";
                ...
                if (firebaseError != null) {
                    FirebaseDB.this.androidUIHandler.post(new Runnable() {
                        public final void run() {
                            ...
                            Log.i(FirebaseDB.LOG_TAG, "AppendValue(onComplete): result.err: " + result.M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu);
                            FirebaseDB.this.FirebaseError(firebaseError.getMessage());
                        }
                    });
                } else if (!z) {
                    FirebaseDB.this.androidUIHandler.post(new Runnable() {
                        public final void run() {
                            Log.i(FirebaseDB.LOG_TAG, "AppendValue(!committed): result.err: " + result.M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu);
                            FirebaseDB.this.FirebaseError(result.M2XSrcNVsTj86KbWYhtzmFwqCl4FRN4hJC3YQ2jC5nTG9V14APZgqJsIs4HMKSeu);
                        }
                    });
