...
public class Marker extends MapFeatureBaseWithFill implements MapFactory.MapMarker {
    ...
    private HorizontalAlignment f234hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = HorizontalAlignment.Center;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private VerticalAlignment f235hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = VerticalAlignment.Bottom;
    ...
    private GeoPoint f236wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou = new GeoPoint(0.0d, 0.0d);
    ...
    public void Latitude(double d) {
        ...
        this.f236wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.setLatitude(d);
        clearGeometry();
    ...
    public double Latitude() {
        return this.f236wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.getLatitude();
    }
    ...
    public void Longitude(double d) {
        ...
        this.f236wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.setLongitude(d);
        clearGeometry();
        this.map.getController().updateFeaturePosition((MapFactory.MapMarker) this);
    }
    ...
    public double Longitude() {
        return this.f236wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.getLongitude();
    }
    ...
    public HorizontalAlignment AnchorHorizontalAbstract() {
        return this.f234hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    }

    public void AnchorHorizontalAbstract(HorizontalAlignment horizontalAlignment) {
        if (horizontalAlignment != this.f234hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME) {
            this.f234hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = horizontalAlignment;
            this.map.getController().updateFeaturePosition((MapFactory.MapMarker) this);
        }
    }
    ...
    public void AnchorVerticalAbstract(VerticalAlignment verticalAlignment) {
        if (verticalAlignment != null) {
            this.f235hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = verticalAlignment;
            this.map.getController().updateFeaturePosition((MapFactory.MapMarker) this);
        }
    }
    ...
    public void SetLocation(double d, double d2) {
        ...
        this.f236wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.setCoords(d, d2);
        clearGeometry();
        this.map.getController().updateFeaturePosition((MapFactory.MapMarker) this);
    }
    ...
    public double BearingToPoint(double d, double d2) {
        return this.f236wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.bearingTo(new GeoPoint(d, d2));
    }
    ...
    public IGeoPoint getLocation() {
        return this.f236wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou;
    }

    public void updateLocation(double d, double d2) {
        this.f236wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou = new GeoPoint(d, d2);
        clearGeometry();
    }
    ...
    public Geometry computeGeometry() {
        return GeometryUtil.createGeometry(this.f236wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou);
    }
}
