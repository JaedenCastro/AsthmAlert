...
public final class Ratingbar extends AndroidViewComponent implements RatingBar.OnRatingBarChangeListener {
    ...
    private final RatingBar f243hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public Ratingbar(ComponentContainer componentContainer) {
        ...
        this.f243hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = ratingBar;
    ...
    public final void SetNumberOfStars(int i) {
        this.f243hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setNumStars(i);
    }

    @SimpleProperty(description = "Returns the number of stars shown.")
    public final int GetNumberOfStars() {
        return this.f243hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getNumStars();
    }
    ...
    public final void IsIndicator(boolean z) {
        this.f243hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setIsIndicator(z);
    }

    @SimpleProperty(description = "Sets the rating (the number of stars filled).")
    public final void SetRating(float f) {
        this.f243hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setRating(f);
    }

    @SimpleProperty(description = "Gets the current rating (number of stars filled).")
    public final float GetRating() {
        return this.f243hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getRating();
    }
    ...
    public final void SetStepSize(float f) {
        this.f243hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setStepSize(f);
    }

    @SimpleProperty(description = "Gets the step size (granularity) of this rating bar.")
    public final float GetStepSize() {
        return this.f243hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getStepSize();
    }
