...
public class Metadata extends AndroidNonvisibleComponent implements Component {
    ...
    public String IQizCoownq3QMuqjiN3SEtpvqAzYOMGAuQhX0ytYpmBBjgggyq4HRoSxolTbNj90;
            ...
            public final void run() {
                Metadata.this.form.askPermission("android.permission.READ_EXTERNAL_STORAGE", new PermissionResultHandler() {
                    public final void HandlePermissionResponse(String str, boolean z) {
                        if (z) {
                            if (str == null) {
                                String unused = Metadata.this.IQizCoownq3QMuqjiN3SEtpvqAzYOMGAuQhX0ytYpmBBjgggyq4HRoSxolTbNj90 = "";
                            } else {
                                String unused2 = Metadata.this.IQizCoownq3QMuqjiN3SEtpvqAzYOMGAuQhX0ytYpmBBjgggyq4HRoSxolTbNj90 = str;
                            }
    ...
    private java.lang.String hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(android.graphics.Bitmap r6) {
        /*
            ...
            java.lang.String r4 = "/"
            r3.append(r4)     // Catch:{ PermissionException -> 0x007c, Exception -> 0x0060 }
            java.lang.String r4 = r5.IQizCoownq3QMuqjiN3SEtpvqAzYOMGAuQhX0ytYpmBBjgggyq4HRoSxolTbNj90     // Catch:{ PermissionException -> 0x007c, Exception -> 0x0060 }
            r3.append(r4)     // Catch:{ PermissionException -> 0x007c, Exception -> 0x0060 }
