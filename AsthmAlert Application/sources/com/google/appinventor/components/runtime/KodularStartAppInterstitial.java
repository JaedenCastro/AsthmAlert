...
public final class KodularStartAppInterstitial extends AndroidNonvisibleComponent {
    ...
    public boolean jfz4esSp2gG8GcabwIhRTwYj9V6OBMxneQTmg596S0YedndAxvJdoaPHqPTMCjiO = false;
    ...
    public final void LoadAd() {
        ...
        this.startAppAd.loadAd(new AdEventListener() {
            public final void onReceiveAd(Ad ad) {
                ...
                boolean unused = KodularStartAppInterstitial.this.jfz4esSp2gG8GcabwIhRTwYj9V6OBMxneQTmg596S0YedndAxvJdoaPHqPTMCjiO = true;
                KodularStartAppInterstitial.this.OnReceiveAd();
            }

            public final void onFailedToReceiveAd(Ad ad) {
                boolean unused = KodularStartAppInterstitial.this.jfz4esSp2gG8GcabwIhRTwYj9V6OBMxneQTmg596S0YedndAxvJdoaPHqPTMCjiO = false;
