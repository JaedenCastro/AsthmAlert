...
public final class KodularLottie extends AndroidViewComponent {
    ...
    public KodularLottie(ComponentContainer componentContainer) {
        ...
        Height(-1);
        Width(-1);
        Source(this.xy1Y0dkIX1oFLPndkUFF3zQF6ijcSVPdmgekjoDrBgvDBhvpj0INgajUPNaUhxY6);
        LoopAnimation(this.f9MsIiC6MxciaFVJmtpdDaPCPu1tdZDTYoHbgfSwKXBhLXF2LgZTKbRmVlZ1kb0Z);
