...
public final class MakeroidChromeCustomTabs extends AndroidNonvisibleComponent {
    ...
    private boolean UrHg3UsNYt3X05ajxF1PWwC50ZBDolbLcJ2ocoWwvC2Xge7OsQI3Tkbaki1SJsz5 = true;
    ...
    public final void PreferNative(boolean z) {
        this.UrHg3UsNYt3X05ajxF1PWwC50ZBDolbLcJ2ocoWwvC2Xge7OsQI3Tkbaki1SJsz5 = z;
    }
    ...
    public final void OpenCustomTab() {
        ...
        try {
            ...
            this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setInstantAppsEnabled(this.x3f9w7ebWg4JdbY2pEu0Z0lXjvABueY447WcywG8LgLVE2M0xoLkgBxoCJuK6Oc);
            CustomTabsIntent build = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.build();
            if (this.UrHg3UsNYt3X05ajxF1PWwC50ZBDolbLcJ2ocoWwvC2Xge7OsQI3Tkbaki1SJsz5 && (packageNameToUse = KodularChromeCustomTabsHelper.getPackageNameToUse(this.context)) != null) {
