...
public class MakeroidFab extends AndroidNonvisibleComponent implements View.OnClickListener, View.OnLongClickListener, Component, OnOrientationChangeListener {
    ...
    private FrameLayout.LayoutParams f205B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;
    ...
    private boolean YgDmThmc2Ht6J8LKfKFuGtMLp2AoFjdDlIONA2izriJdICsKCPKMX3dYEj8K1z4k = true;
    ...
    private FloatingActionButtonExtension f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public MakeroidFab(ComponentContainer componentContainer) {
        ...
        this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = new FloatingActionButtonExtension();
        Initialize();
    ...
    private void Initialize() {
        ...
        this.f205B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = layoutParams;
        ...
        this.f205B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.gravity = 8388693;
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setLayoutParams(this.f205B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T);
        ...
        this.activity.addContentView(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, this.f205B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T);
    ...
    public void onOrientationChange() {
        Initialize();
        FloatingActionButtonExtension floatingActionButtonExtension = this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public void MarginRight(int i) {
        ...
        this.f205B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.setMargins(0, 0, KodularUnitUtil.DpToPixels((Context) this.activity, i), KodularUnitUtil.DpToPixels((Context) this.activity, this.n86Bi3TT8lkq4OIAY6TQzz40yEQcROLeML3EOzGKfDOtlcMXWXcB7P2XOFzT0DDv));
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setLayoutParams(this.f205B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T);
    ...
    public void MarginBottom(int i) {
        ...
        this.f205B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.setMargins(0, 0, KodularUnitUtil.DpToPixels((Context) this.activity, this.gti6bIqu0aXgALoDtkq1foMnPcdzXO0EAPAgw4lcaEF132GirFLns82VqwKc8x6R), KodularUnitUtil.DpToPixels((Context) this.activity, i));
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setLayoutParams(this.f205B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T);
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.invalidate();
    }
    ...
    public void ShowTextMessage() {
        this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.showText();
    }

    @SimpleFunction(description = "Hides text message.")
    public void HideTextMessage() {
        this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.hideText();
    }
    ...
    public void TextMessageText(String str) {
        this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setText(str);
    }

    @SimpleProperty(description = "Get the text message.")
    public String TextMessageText() {
        return this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getText();
    }

    @DesignerProperty(defaultValue = "&HFFFFFFFF", editorType = "color", propertyType = "advanced")
    @SimpleProperty(description = "Set the text message color.")
    public void TextMessageTextColor(int i) {
        this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setTextColor(i);
    }

    @SimpleProperty(description = "Get the text message color.")
    public int TextMessageTextColor() {
        return this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getTextColor();
    }
    ...
    public void TextMessageBackgroundColor(int i) {
        this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setBackgroundColor(i);
    }

    @SimpleProperty(description = "Get the text message background color.")
    public int TextMessageBackgroundColor() {
        return this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getBackgroundColor();
    }
    ...
    public void TextMessageCornerRadius(float f) {
        this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.cornerRadius = f;
    }

    @SimpleProperty(description = "Get the text message corner radius.")
    public float TextMessageCornerRadius() {
        return this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.cornerRadius;
    }
    ...
    public void ShowTextMessageOnLeftSide(boolean z) {
        this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setShowTextOnLeftSide(z);
    }

    @SimpleProperty(description = "Return true if the text message is on the left side.")
    public boolean ShowTextMessageOnLeftSide() {
        return this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isShowTextOnLeftSide();
    }
    ...
    public void HideTextMessageOnTextClick(boolean z) {
        this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setHideTextOnClick(z);
    }
    ...
    public boolean HideTextMessageOnTextClick() {
        return this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isHideTextOnClick();
    }
    ...
    public void HideTextMessageOnTextLongClick(boolean z) {
        this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setHideTextOnLongClick(z);
    }
    ...
    public boolean HideTextMessageOnTextLongClick() {
        return this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isHideTextOnLongClick();
    }
    ...
    public void CallFabClickOnTextMessageClick(boolean z) {
        this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setCallFabClickOnTextClick(z);
    }
    ...
    public boolean CallFabClickOnTextMessageClick() {
        return this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isCallFabClickOnTextClick();
    }
    ...
    public void CallFabLongClickOnTextMessageLongClick(boolean z) {
        this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setCallFabLongClickOnTextLongClick(z);
    }
    ...
    public boolean CallFabLongClickOnTextMessageLongClick() {
        return this.f206hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isCallFabLongClickOnTextLongClick();
    }
}
