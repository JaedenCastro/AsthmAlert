...
public final class Download extends AndroidNonvisibleComponent implements Component {
    ...
    private String DmQGLROFyZ9Eo0RSsJcpZNxJZjgcsPDfYPi3awNwmyyErT71sGU5mvgG4PDW3yL = "Download..";

    /* renamed from: DmQGLROFyZ9Eo0RSsJcpZNxJZjgcsPDfYPi3awNwmyyErT71sGU5mvgG4PDW3yL  reason: collision with other field name */
    private boolean f77DmQGLROFyZ9Eo0RSsJcpZNxJZjgcsPDfYPi3awNwmyyErT71sGU5mvgG4PDW3yL = false;
    private boolean G9FdWvm6zShqpzDC2UOqX6MiQExLolZTefPBjzVvfkE9Kp2rmQld5rkb2wriBYfL = true;
    private String IhlDYVsQmgat6F3NXqRok975lHQlAvyJICX3QHDdE383xYIGTapMORiCm1KjyWCi = "Downloading file..";
    ...
    private String ZXVyhZW2wwbAysjXrMReFP00vcRkftFV6dFiSCOUB0OBlMJVjuhF9XlRGX7w6PdR = "";
    ...
    private String vB3WjEtL56PUGm0spJ96S19MI1O4vPR6yju8tUYcKrC4atk0AV5GbVcHQNB7BlIK = "NewFile.png";
    ...
    public final void ScanningByMediaScanner(boolean z) {
        ...
        this.G9FdWvm6zShqpzDC2UOqX6MiQExLolZTefPBjzVvfkE9Kp2rmQld5rkb2wriBYfL = z;
    }
    ...
    public final void RequiresDeviceIdle(boolean z) {
        ...
        this.f77DmQGLROFyZ9Eo0RSsJcpZNxJZjgcsPDfYPi3awNwmyyErT71sGU5mvgG4PDW3yL = z;
    }
    ...
    public final boolean RequiresDeviceIdle() {
        return this.f77DmQGLROFyZ9Eo0RSsJcpZNxJZjgcsPDfYPi3awNwmyyErT71sGU5mvgG4PDW3yL;
    }
    ...
    private void sSQuIBUVrx5rcdxHqHgqC6bPLuuDnxnBF7e7BJeOxmxr54l6ArzFZvC3SGBTuUdt() {
        try {
            DownloadManager.Request request = new DownloadManager.Request(Uri.parse(this.ZXVyhZW2wwbAysjXrMReFP00vcRkftFV6dFiSCOUB0OBlMJVjuhF9XlRGX7w6PdR));
            request.setDescription(this.IhlDYVsQmgat6F3NXqRok975lHQlAvyJICX3QHDdE383xYIGTapMORiCm1KjyWCi);
            request.setTitle(this.DmQGLROFyZ9Eo0RSsJcpZNxJZjgcsPDfYPi3awNwmyyErT71sGU5mvgG4PDW3yL);
            request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, this.vB3WjEtL56PUGm0spJ96S19MI1O4vPR6yju8tUYcKrC4atk0AV5GbVcHQNB7BlIK);
            request.setAllowedOverRoaming(this.gti6bIqu0aXgALoDtkq1foMnPcdzXO0EAPAgw4lcaEF132GirFLns82VqwKc8x6R);
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                if (this.f77DmQGLROFyZ9Eo0RSsJcpZNxJZjgcsPDfYPi3awNwmyyErT71sGU5mvgG4PDW3yL) {
    ...
    class b extends AsyncTask<String, Void, Integer> {
        ...
        private b() {
            this.PJTNEFub7t830GnsJOreZR2G4QGerhYk5JzZTaNM1rn2OjCmiPf1GPWMoDtnF4UY = null;
        }
        ...
        public java.lang.Integer doInBackground(java.lang.String... r4) {
            /*
                ...
                java.lang.String r2 = r3.PJTNEFub7t830GnsJOreZR2G4QGerhYk5JzZTaNM1rn2OjCmiPf1GPWMoDtnF4UY     // Catch:{ Exception -> 0x0031 }
