...
public final class SoundRecorder extends AndroidNonvisibleComponent implements MediaRecorder.OnErrorListener, MediaRecorder.OnInfoListener, Component {
    ...
    class a {
        final String T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq;
    ...
    public final void Start() {
        String[] strArr;
        String resolveFileName = FileUtil.resolveFileName(this.form, this.peQa36WzmOGDKVPxAtWvq1pN83yXrV2fw2e1QvLyEngIwdojN2EAkDoWXzH8bj7w, this.form.DefaultFileScope());
        if (!this.havePermission) {
            ...
            if (MediaUtil.isExternalFile(this.form.$context(), this.peQa36WzmOGDKVPxAtWvq1pN83yXrV2fw2e1QvLyEngIwdojN2EAkDoWXzH8bj7w)) {
            ...
            Log.i("SoundRecorder", "Start() called, but already recording to " + this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq);
        } else {
            ...
            if (!FileUtil.isExternalStorageUri(this.form, resolveFileName) || Environment.getExternalStorageState().equals("mounted")) {
                try {
                    if (!this.peQa36WzmOGDKVPxAtWvq1pN83yXrV2fw2e1QvLyEngIwdojN2EAkDoWXzH8bj7w.equals("")) {
                        File parentFile = new File(this.peQa36WzmOGDKVPxAtWvq1pN83yXrV2fw2e1QvLyEngIwdojN2EAkDoWXzH8bj7w).getParentFile();
                        if (!parentFile.exists()) {
                            parentFile.mkdirs();
                        }
                    }
                    a aVar = new a(this.peQa36WzmOGDKVPxAtWvq1pN83yXrV2fw2e1QvLyEngIwdojN2EAkDoWXzH8bj7w);
    ...
    public final void Stop() {
        ...
        L_0x000c:
            ...
            java.lang.String r3 = r3.T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq     // Catch:{ all -> 0x003e }
            ...
            java.lang.String r1 = r1.T3TEUSUxjrJVucuujQ9pjstrX3UcxHV1L9cOGs7CI5pfz9hjmRfdL7GRyW8ebdVq     // Catch:{ all -> 0x003e }
