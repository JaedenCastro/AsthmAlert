...
public class Ev3Motors extends LegoMindstormsEv3Base {
    ...
    private boolean PnDqXmvCFreSiRVUA0g9XAstwDhIMcbRjkGmb4HpU47gHx12PSApiyWiV1UWvlkR = false;
    ...
    private boolean kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA = false;
    private boolean lAud5RKvmdA6itPf25e72aHL9NdNsPWhE0ialf61Le8xYV1HI3NTt1XJfRo1B6Y = true;
    ...
    public void TachoCountChangedEventEnabled(boolean z) {
        this.W6T0KLh0HOscnxSkBKrzTm675pNrsPjnoOd2dFOC45d2E2zbErFUDn8t6kBqwFa = z;
    }
    ...
    public void ToggleDirection() {
        try {
            ...
            this.PnDqXmvCFreSiRVUA0g9XAstwDhIMcbRjkGmb4HpU47gHx12PSApiyWiV1UWvlkR = !this.PnDqXmvCFreSiRVUA0g9XAstwDhIMcbRjkGmb4HpU47gHx12PSApiyWiV1UWvlkR;
        } catch (IllegalArgumentException unused) {
    ...
    public void beforeDisconnect(BluetoothConnectionBase bluetoothConnectionBase) {
        if (this.lAud5RKvmdA6itPf25e72aHL9NdNsPWhE0ialf61Le8xYV1HI3NTt1XJfRo1B6Y) {
            try {
