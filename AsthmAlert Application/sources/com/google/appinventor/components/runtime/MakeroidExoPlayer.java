...
public class MakeroidExoPlayer extends AndroidNonvisibleComponent implements AudioManager.OnAudioFocusChangeListener, Component, OnDestroyListener {
    ...
    private SimpleExoPlayer f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    /* access modifiers changed from: private */
    public String kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA = "";
    /* access modifiers changed from: private */
    public boolean nKfZQ1laYcwrzNEumUwCbmi2kaHgg3eE1c9SDtYVLTkiuRTWxcP8Pqqx3AbL5ow = false;
    ...
    public MakeroidExoPlayer(ComponentContainer componentContainer) {
        ...
        this.bg8qLM0P8YgZYqRlUjDxWnoKnWRYKRDQeEjqrx0ja4Cy7jLWl3M1lZwjImM82eG = AppName();
        ...
        this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = newSimpleInstance;
        newSimpleInstance.addListener(new Player.EventListener() {
            ...
            public final void onLoadingChanged(boolean z) {
                ...
                makeroidExoPlayer.StatusChanged(MakeroidExoPlayer.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(makeroidExoPlayer), MakeroidExoPlayer.this.isPause, MakeroidExoPlayer.this.AVN1jEMUjULIMlY3UvkBgLtaEKU1Kh7f4RsRo8tJ6i96580YKtIBKDpaBPwG4gsl, z);
            }

            public final void onPlayerStateChanged(boolean z, int i) {
                if (i == 4) {
                    try {
                        if (!MakeroidExoPlayer.this.nKfZQ1laYcwrzNEumUwCbmi2kaHgg3eE1c9SDtYVLTkiuRTWxcP8Pqqx3AbL5ow) {
                            boolean unused = MakeroidExoPlayer.this.isPlaying = false;
                            boolean unused2 = MakeroidExoPlayer.this.isPause = false;
                            boolean unused3 = MakeroidExoPlayer.this.AVN1jEMUjULIMlY3UvkBgLtaEKU1Kh7f4RsRo8tJ6i96580YKtIBKDpaBPwG4gsl = true;
                        }
        ...
        SimpleExoPlayer simpleExoPlayer = this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public void Stop() {
        try {
            ...
            if (this.isPlaying || this.isPause) {
                simpleExoPlayer.setPlayWhenReady(false);
                this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.seekTo(0);
                this.AVN1jEMUjULIMlY3UvkBgLtaEKU1Kh7f4RsRo8tJ6i96580YKtIBKDpaBPwG4gsl = true;
    ...
    public void Pause() {
        try {
            ...
            if (simpleExoPlayer != null && this.isPlaying) {
                ...
                StatusChanged(false, true, false, this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isLoading());
            }
        } catch (Exception e) {
            Log.e("ExoPlayer", String.valueOf(e));
        }
    ...
    public void Start() {
        try {
            ...
            if (simpleExoPlayer != null) {
                ...
                this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setPlayWhenReady(true);
                this.isPlaying = true;
                this.isPause = false;
                this.AVN1jEMUjULIMlY3UvkBgLtaEKU1Kh7f4RsRo8tJ6i96580YKtIBKDpaBPwG4gsl = false;
                StatusChanged(true, false, false, this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isLoading());
                Volume(this.e1IHYfRNckEvpOWbFvMtuN7w9PEpZtVYShhIlzbQR8mwSxiOizA6OYtX7vMfGCUT);
                Loop(this.nKfZQ1laYcwrzNEumUwCbmi2kaHgg3eE1c9SDtYVLTkiuRTWxcP8Pqqx3AbL5ow);
            }
        } catch (Exception e) {
            Log.e("ExoPlayer", String.valueOf(e));
        }
    ...
    public void Volume(int i) {
        ...
        if (this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setVolume((float) (1.0d - (Math.log((double) (100 - i)) / Math.log(100.0d))));
        }
    ...
    public boolean isLoading() {
        return this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isLoading();
    }
    ...
    public void SeekTo(int i) {
        ...
        if (simpleExoPlayer != null) {
            ...
            if (i2 <= ((int) this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getDuration())) {
                this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.seekTo((long) i2);
            } else {
                this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.seekTo((long) currentPosition);
            }
        }
    }
    ...
    public void Source(String str) {
        this.kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA = str;
        boolean z = false;
        if (str.isEmpty()) {
            this.form.dispatchErrorOccurredEvent(this, "Source", ErrorMessages.ERROR_UNABLE_TO_LOAD_MEDIA, str);
        } else if (this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            String str2 = this.kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA;
            ...
            if (z) {
                ...
                ExtractorMediaSource.Factory extractorsFactory = new ExtractorMediaSource.Factory(new DefaultDataSourceFactory(context2, Util.getUserAgent(context2, this.bg8qLM0P8YgZYqRlUjDxWnoKnWRYKRDQeEjqrx0ja4Cy7jLWl3M1lZwjImM82eG), new DefaultBandwidthMeter())).setExtractorsFactory(new DefaultExtractorsFactory());
                String str3 = this.kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA;
            ...
            String str4 = this.kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA;
            StringBuilder sb = new StringBuilder();
            sb.append(this.context.getExternalFilesDir(""));
            if (str4.contains(sb.toString())) {
                try {
                    hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(new File(this.kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA));
                } catch (Exception e) {
                    Log.e("ExoPlayer", String.valueOf(e));
                }
            } else {
                                ...
                                if (z) {
                                    try {
                                        if (MakeroidExoPlayer.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(MakeroidExoPlayer.this).startsWith("file:///")) {
                                            String unused = MakeroidExoPlayer.this.kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA = MakeroidExoPlayer.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(MakeroidExoPlayer.this).substring(7);
                                        }
                                        if (MakeroidExoPlayer.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(MakeroidExoPlayer.this).startsWith("/storage/emulated/0/") || MakeroidExoPlayer.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(MakeroidExoPlayer.this).startsWith("/storage/emulated/1/")) {
                                            String unused2 = MakeroidExoPlayer.this.kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA = MakeroidExoPlayer.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(MakeroidExoPlayer.this).substring(19);
                                        }
    ...
    public void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(File file) {
        Log.i("ExoPlayer", "ExoPlayer source path: " + this.kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA);
        if (file.exists()) {
            Context context2 = this.context;
            Uri uriForFile = FileProvider.getUriForFile(context2, this.context.getPackageName() + ".provider", file);
            SimpleExoPlayer simpleExoPlayer = this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
            Context context3 = this.context;
            simpleExoPlayer.prepare(new ExtractorMediaSource.Factory(new DefaultDataSourceFactory(context3, Util.getUserAgent(context3, this.bg8qLM0P8YgZYqRlUjDxWnoKnWRYKRDQeEjqrx0ja4Cy7jLWl3M1lZwjImM82eG), new DefaultBandwidthMeter())).setExtractorsFactory(new DefaultExtractorsFactory()).createMediaSource(uriForFile));
            return;
        }
        this.form.dispatchErrorOccurredEvent(this, "Source", ErrorMessages.ERROR_CANNOT_FIND_FILE, this.kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA);
    }
    ...
    public void onDestroy() {
        try {
            ...
            if (simpleExoPlayer != null) {
                ...
                this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.release();
                this.f204hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = null;
            }
        } catch (Exception e) {
            Log.e("ExoPlayer", String.valueOf(e));
        }
