...
public class PolyUtil {
    ...
    private final RectF f301hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = new RectF();
    ...
    public void constructPolygonPath(Path path, int i, float f, float f2, float f3, float f4, float f5) {
        ...
        if (((double) Math.abs(f4)) < 0.01d) {
            ...
            while (i4 < i2) {
                ...
                this.f301hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.set(cos3 - f8, sin3 - f8, cos3 + f8, sin3 + f8);
                path2.arcTo(this.f301hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, (float) (d6 - ((double) f9)), 2.0f * f9);
                i4++;
                i2 = i;
                f6 = f;
                d2 = d7;
