...
public class KodularRSA {
    ...
    private static PublicKey f331hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    public static KeyPair buildKeyPair() throws NoSuchAlgorithmException {
        KeyPair buildKeyPair = buildKeyPair();
        f331hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = buildKeyPair.getPublic();
    ...
    public static String decrypt(String str) throws Exception {
        try {
            return new String(decrypt(f331hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, str.getBytes()));
        } catch (Exception e) {
            Log.e("MakeroidCrypt", e.getMessage());
            return "";
        }
