...
public class ClientLoginHelper implements IClientLoginHelper {
    ...
    private HttpClient f282hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public ClientLoginHelper(Activity activity2, String str, String str2, DefaultHttpClient defaultHttpClient) {
        ...
        this.f282hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = defaultHttpClient == null ? new DefaultHttpClient() : defaultHttpClient;
    ...
    public String getAuthToken() throws ClientProtocolException {
        ...
        if (findAccount != null) {
            AccountManagerFuture<Bundle> authToken2 = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getAuthToken(findAccount, this.h8Png9oaVDfYGvgWdHcn1DMBnn2tbT5MRZoUvXvvhLrY5O6ybby2QmTOJ6PZJucW, (Bundle) null, this.activity, (AccountManagerCallback) null, (Handler) null);
    ...
    public HttpResponse execute(HttpUriRequest httpUriRequest) throws ClientProtocolException, IOException {
        ...
        HttpResponse execute = this.f282hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.execute(httpUriRequest);
        ...
        return this.f282hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.execute(httpUriRequest);
    }
}
