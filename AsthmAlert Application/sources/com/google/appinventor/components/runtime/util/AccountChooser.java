...
public class AccountChooser {
    ...
    class a extends Thread implements DialogInterface.OnCancelListener, DialogInterface.OnClickListener {
        ...
        private SynchronousQueue<String> f281hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

        a(Account[] accountArr, SynchronousQueue<String> synchronousQueue) {
            this.f281hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = synchronousQueue;
        ...
        public final void onClick(DialogInterface dialogInterface, int i) {
            if (i >= 0) {
                try {
                    ...
                    this.f281hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.put(str);
                } catch (InterruptedException unused) {
                }
            } else {
                this.f281hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.put("");
            }
