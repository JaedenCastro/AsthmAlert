    ...
    public NanoHTTPD.Response serve(String str, String str2, Properties properties, Properties properties2, Properties properties3, Socket socket) {
        ...
        if (str3.equals("/_newblocks")) {
            ...
            if (str3.equals("/_values")) {
                ...
                Log.d("AppInvHTTPD", this.hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO + "/" + property7);
                Intent intent = new Intent("android.intent.action.VIEW");
                intent.setDataAndType(Uri.fromFile(new File(this.hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO + "/" + property7)), "application/vnd.android.package-archive");
                ...
                if (str2.equals("PUT")) {
                    ...
                    if (property8 != null) {
                        ...
                        if (property9 != null) {
                            File file2 = new File(this.hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO + "/" + property9);
                ...
                if (propertyNames4.hasMoreElements()) {
                    ...
                    if (property11 == null) {
                        ...
                        File file4 = new File(this.hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO + "/" + property11);
