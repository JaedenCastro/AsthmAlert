...
public class TinyWebDB extends AndroidNonvisibleComponent implements Component {
    ...
    private String qGWPhAhbC1tFmaPVJJBRlTuvq3PUzuXLHqwJdn0xNpZNZK6IOnxu2nEwTjRZ3Ww = "http://tinywebdb.builder.makeroid.io/";
    ...
    public void ServiceURL(String str) {
        this.qGWPhAhbC1tFmaPVJJBRlTuvq3PUzuXLHqwJdn0xNpZNZK6IOnxu2nEwTjRZ3Ww = str;
    }
    ...
    static /* synthetic */ void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(TinyWebDB tinyWebDB, String str, Object obj) {
        ...
        try {
            WebServiceUtil.getInstance().postCommand(tinyWebDB.qGWPhAhbC1tFmaPVJJBRlTuvq3PUzuXLHqwJdn0xNpZNZK6IOnxu2nEwTjRZ3Ww, "storeavalue", Lists.newArrayList(new BasicNameValuePair(HeaderParameterNames.AUTHENTICATION_TAG, str), new BasicNameValuePair(CommonProperties.VALUE, JsonUtil.getJsonRepresentation(obj))), r0);
    ...
    static /* synthetic */ void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(TinyWebDB tinyWebDB, final String str) {
        ...
        WebServiceUtil.getInstance().postCommandReturningArray(tinyWebDB.qGWPhAhbC1tFmaPVJJBRlTuvq3PUzuXLHqwJdn0xNpZNZK6IOnxu2nEwTjRZ3Ww, "getvalue", Lists.newArrayList(new BasicNameValuePair(HeaderParameterNames.AUTHENTICATION_TAG, str)), r0);
    }
}
