...
public class Navigation extends AndroidNonvisibleComponent implements Component {
    ...
    public YailDictionary f237hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = YailDictionary.makeDictionary();
    ...
    public void Language(String str) {
        this.tFNQ38WX0EWx1sBmwkfGOavwj0ohdRyv5RfL5KQ0qa5Pnr6qc7YsZTQu1aP3NtmA = str;
    }
    ...
    static /* synthetic */ void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(Navigation navigation, GeoPoint geoPoint, GeoPoint geoPoint2, TransportMethod transportMethod) throws IOException, JSONException {
        ...
        HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(navigation2.vQeIU3Nt6lISgDcgPcgMyfTsPOzVWtilFVqv3Ws2SOY6jXuMnX7gL1LFHvLOLuoZ + transportMethod.toUnderlyingValue() + "/geojson/").openConnection();
        ...
        httpURLConnection.setRequestProperty(Constants.AUTHORIZATION_HEADER, navigation2.qPA23Y7cwrM2jVYdTZaCOyuoTEsak9zRoCsFocZMlDYlamZRzkT9xY09N4QNxUyM);
        try {
            ...
            sb.append(", \"language\": \"");
            sb.append(navigation2.tFNQ38WX0EWx1sBmwkfGOavwj0ohdRyv5RfL5KQ0qa5Pnr6qc7YsZTQu1aP3NtmA);
            sb.append("\"}");
            ...
            if (yailList.size() > 0) {
                ...
                navigation2.form.runOnUiThread(new Runnable() {
                    public final void run() {
                        YailDictionary unused = Navigation.this.f237hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = yailDictionary;
