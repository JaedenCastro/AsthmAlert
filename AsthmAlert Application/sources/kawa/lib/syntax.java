...
public class syntax extends ModuleBody {
    ...
    public static final Macro f339import;
    ...
    public static final Macro f340synchronized;
    ...
    static {
        ...
        f340synchronized = Macro.make(simpleSymbol78, new ModuleMethod(syntax, 3, (Object) null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), syntax);
        ...
        f339import = Macro.make(simpleSymbol66, syntaxRules10, syntax);
