...
public class std_syntax extends ModuleBody {
    ...
    public static final Macro f337case;
    ...
    public static final Macro f338do;
    ...
    static {
        ...
        f337case = Macro.make(simpleSymbol81, syntaxRules32, std_syntax);
        ...
        f338do = Macro.make(simpleSymbol54, syntaxRules10, std_syntax);
